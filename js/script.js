// 商品資料
const products = [
    { id: 1, name: '零食貨架', price: 1, img: 'src/icon.png', desc: '上面有很多好吃的零食' },
    { id: 2, name: '相片四張', price: 1, img: 'src/icon.png', desc: '教授與女兒的合照' },
    ...
    { id: 10, name: '研究員日誌*2', price: 1, img: 'src/icon.png', desc: '某藥水的配方' },
    { id: 11, name: '細胞模型', price: 1, img: 'src/icon.png', desc: '顯微鏡下的世界' },
    { id: 12, name: '蛋白行進圖', price: 1, img: 'src/icon.png', desc: '有點像恐龍的東東' },
    { id: 13, name: '元素週期表', price: 1, img: 'src/icon.png', desc: '好像不是平常看到的週期表' },
    { id: 14, name: '筆記紙四頁', price: 1, img: 'src/icon.png', desc: '文化小筆記' },
    { id: 15, name: '卡牌一副', price: 1, img: 'src/icon.png', desc: '你想打牌了嗎' },
    { id: 16, name: '一元', price: 0, img: 'src/icon.png', desc: '我知道你想說冷笑話' },
    { id: 17, name: '一元', price: 0, img: 'src/icon.png', desc: '還是你要表演才藝' }
];
